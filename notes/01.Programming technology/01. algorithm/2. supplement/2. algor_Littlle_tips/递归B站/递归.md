...
![1563853220522](assets/1563853220522.png)
...
![1563854311429](assets/1563854311429.png)
...
![图02-19.归并排序实例](assets/图02-19.归并排序实例.png)
...
![图02-18.有序向量的二路归并实例](assets/图02-18.有序向量的二路归并实例.png)
...
![图05-28.二叉树先序遍历序列](assets/图05-28.二叉树先序遍历序列-1549953653371.png)
...
![图05-30.二叉树的中序遍历序列](assets/图05-30.二叉树的中序遍历序列.png)
...
![图05-29.二叉树的后序遍历序列](assets/图05-29.二叉树的后序遍历序列.png)
...
![图05-38.二叉树的层次遍历序列](assets/图05-38.二叉树的层次遍历序列.png)
...
![下载-1533545465415](assets/下载-1533545465415.png)

#### 表达式树的输出与求值

表达式树的特征：叶节点是运算数，非叶节点一定是运算符

![20170603205711071](assets/20170603205711071.jpg)
...
```
(4+(1*(5-2)))-(6/3)		//（表达式树的中序遍历）但是要注意括号的输出
- + 4 * 1 - 5 2 / 6 3   //从右往左计算，前缀表达式（表达式树的先序遍历）
4 1 5 2 - * + 6 3 / -	//从左往右计算，后缀表达式（表达式树的后续遍历）
5.00
```
...
![1532752744356](assets/1532752744356.png)
...
![20170325215438522](assets/20170325215438522.png)
...
![1550062663360](assets/1550062663360.png)
...
![faf2b2119313b07ecb2b3bb80bd7912396dd8cef](assets/faf2b2119313b07ecb2b3bb80bd7912396dd8cef.jpg)

![1550062277175](assets/1550062277175.png)
...
![1549956052178](assets/1549956052178.png)
